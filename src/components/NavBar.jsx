      ...
      featured: [
        {
          ...
          href: "#",
          imageSrc:
            "https://cdn.shopify.com/s/files/1/1770/8517/articles/types-of-gold-jewelry-explained-gold-plated-vermeil-gold-filled-solid-gold.jpg?v=1683319058",
          imageAlt: "A collection of new gold jewelry pieces.",
        },
        {
          name: "Exclusive Designs",
          href: "#",
          imageSrc:
            "https://www.viranijewelers.com/cdn/shop/products/22k-gold-set-BGM6130-100.5-gm-No-Stone-28-31_4_1024x1024.jpg",
          imageAlt: "Elegant gold rings and necklaces on display.",
        },
      ],
      sections: [
        {
          ...
          name: "Necklaces",
          items: [
            { name: "Gold Chains", href: "#" },
            { name: "Pendants", href: "#" },
            { name: "Chokers", href: "#" },
            { name: "Personalized Necklaces", href: "#" },
              ...
              <div className="border-b border-gray-200">
                <TabList className="-mb-px flex space-x-8 px-4">
                  {navigation.categories.map((category) => (
                    <Tab
                      key={category.name}
                      className="flex-1 border-b-2 border-transparent px-1 py-4 text-base font-medium whitespace-nowrap text-gray-900 data-selected:border-yellow-600 data-selected:text-yellow-600"
                    >
                      {category.name}
                    </Tab>
                  ))}
                ...
                <div className="flex h-full space-x-8">
                  ...
                  {navigation.pages.map((page) => (
                    <a
                      key={page.name}
                      href={page.href}
                      className="flex items-center text-sm font-medium text-gray-700 hover:text-yellow-600"
                    >
                      {page.name}
                    </a>
                  ))}
